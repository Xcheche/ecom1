...
class CustomUser(AbstractBaseUser):
    ...
    )  # Optional field for user bio or description
    ...
    is_staff = models.BooleanField(
        default=False
    )  # This is used to check if the user can access the admin site
    ...
    REQUIRED_FIELDS = [
        ...
        "last_name",
        "user_name",
    ]  # Can add phone number i desired to make it requierd field
